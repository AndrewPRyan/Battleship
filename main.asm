...
explosionSound BYTE "C:\Irvine\shipexploding.wav", 0
missSound BYTE "C:\Irvine\shipmiss.wav", 0
hitSound BYTE "C:\Irvine\shiphit.wav", 0
placeSound BYTE "C:\Irvine\shipplace.wav", 0
startSound BYTE "C:\Irvine\startsound.wav", 0
victorySound BYTE "C:\Irvine\victory.wav", 0
defeatSound BYTE "C:\Irvine\defeat.wav", 0
...
;===============================
;
; Translates X-coordinate from
; mouse click to be compatible
; with battleship map
;
; Returns a value to mapIndex*
;
; *mapIndex: Tracks the index
; in any map array
;
;================================
...
;================================
	...
	INVOKE SndPlaySound, OFFSET startSound, 0001
...
; viewed after the initial screen
; before the game starts
;
; This gives the player an
; overview of the game and the
; goals of the game
;
;================================
...
;===============================
;
; Creates the "Battleship" ASCII
; seen on the UI during the game
;
;================================
...
;===============================
;
; Creates both the player and
; computer map for the UI
;
; Specific characters are
; detected and colored depending
; on their use in the game
;
;================================
...
;===============================
;
; Creates additional UI elements
...
;===============================
;
; Clears the area in the UI for
; displaying directions
;
; Assists in keeping the
; direction section of the UI
; clean and readable
;
;================================
...
; player ships total health 
; at a given instance, the total 
; ships is calculated
;
; Returns a count to the UI
; for Ships Remaining
;
;================================
...
;===============================
;
; Places all the player ships on
; the map. Each ship is placed
; using separate procedures
;
; Displays proper directions
; to the player in order to make
; ship placement a seamless
; process
;
;================================
...
;===============================
;
; Places the player carrier on
; the player map
;
; Uses mouse clicks to place ship
; in a given orientation
;	Left: Vertical
;	Right: Horizontal
;
; Called By PlacePlayerShips
; Character on Map: C
; Spaces on Map: 5
;
;================================
	...
	INVOKE SndPlaySound, OFFSET placeSound, 0001
...
;===============================
;
; Checks to see if the attemped
; vertical ship placement is
; valid on the player map
;
; Looks for any edges,
; coordinate bounds ("|"), 
; and other placed ships
;
; Called each time a vertical
; placement is requested by the
; player during ship placement
;
;================================
...
RegisterPlayerHit PROC
	...
	INVOKE SndPlaySound, OFFSET hitSound, 0001
...
RegisterPlayerMiss PROC
	...
	INVOKE SndPlaySound, OFFSET missSound, 0001
...
PlayerShipSunk PROC
	...
	INVOKE SndPlaySound, OFFSET explosionSound, 0001
